...
Modal.propTypes = {
    name: PropTypes.string.isRequired, // or PropTypes.string if not required
    address: PropTypes.string.isRequired, // or PropTypes.string if not required
    pincode: PropTypes.string.isRequired, // or PropTypes.string if not required
    phoneNumber: PropTypes.string.isRequired, // or PropTypes.string if not required
    setName: PropTypes.string.isRequired, // or PropTypes.string if not required
    setAddress: PropTypes.string.isRequired, // or PropTypes.string if not required
    setPincode: PropTypes.string.isRequired, // or PropTypes.string if not required
    setPhoneNumber: PropTypes.string.isRequired, // or PropTypes.string if not required
    buyNow: PropTypes.string.isRequired, // or PropTypes.string if not required
    // Define other prop types
    // e.g., anotherProp: PropTypes.number,
  };
